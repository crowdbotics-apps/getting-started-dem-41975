...
## Project Structure
    ...
    ├── getting_started_dem_41975  # Django project configurations
...
1. Clone this repo and `cd getting_started_dem_41975`
...
2. Clone this repo and `cd getting_started_dem_41975`
